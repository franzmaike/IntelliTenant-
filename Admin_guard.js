...
function showInfo(){
    ...
    getData.forEach((element, index) => {
       ...
       <td>${element.STimeO}</td>
            ...
            <td>
                <button class="btn btn-success" onclick="readInfo('${element.picture}', '${element.employeeFirstname}', '${element.employeeLastname}',  '${element.employeeStatus}', '${element.Floor}', '${element.STimeI}',             '${element.STimeO}')" data-bs-toggle="modal" data-bs-target="#readData"><i class="bi bi-eye"></i></button>

                <button class="btn btn-primary" onclick="editInfo(${index}, '${element.picture}', '${element.employeeFirstname}', '${element.employeeLastname}', '${element.employeeStatus}', '${element.Floor}', '${element.STimeI}',
...
function readInfo(pic, Firstname,Lastname, Status, Floor, STimeI, STimeO){
...
function editInfo(index, pic, Firstname, Lastname, Status, Floor, STimeI, STimeO){
    isEdit = true
    editId = index
    imgInput.src = pic,
